...
const AddVehicleModal = ({ isOpen, onClose, onSave, editingVehicle }) => {
  ...
  useEffect(() => {
    if (editingVehicle) {
      setFormData({
        ...
        make: editingVehicle.make || editingVehicle.company || "",
        isVerified: editingVehicle.isVerified || false,
  ...
  const handleSubmit = async (e) => {
    ...
    // Construct data according to requested API schema
    const vehicleData = {
      ...
      extraHoursSurchargeRate: Number(formData.extraHoursSurchargeRate),
      foodSurchargeAllowance: Number(formData.foodSurchargeAllowance),
      isVerified: formData.isVerified,
      yearOfMaking: Number(formData.yearOfMaking),
  ...
  const DocumentUploadCard = ({
    ...
    return (
      <div
        className={`${className} bg-gray-50 dark:bg-gray-800/30 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl p-3 text-center hover:border-primary-yellow transition-all`}
      >
        ...
        <h3 className="font-semibold text-xs text-gray-800 dark:text-white mb-1">
          {title}
        </h3>
        ...
        {displayUrl && (
          <div className="mb-2">
            <img
              src={displayUrl}
              alt={title}
              className="max-h-16 mx-auto rounded-lg"
            />
          </div>
        )}
  ...
  const getExpiryWarning = (expiryDate) => {
    ...
    if (daysLeft < 0)
      return { color: "border-red-500 bg-red-50", text: "Expired", icon: "🔴" };
    if (daysLeft <= 30)
      return {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-5xl my-8 max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-3 p-4 bg-indigo-50/50 dark:bg-indigo-900/10 rounded-xl border border-indigo-100 dark:border-indigo-900/30">
            <h3 className="text-base font-semibold text-indigo-900 dark:text-indigo-400">
              ...
              <div className="flex items-end pb-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded text-primary-yellow focus:ring-primary-yellow"
                  />
                  <span className="text-sm font-medium">Vehicle Verified</span>
                </label>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, vendorGender: e.target.value })
                  }
                  className="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-yellow dark:bg-gray-800"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, vendorAadhar: e.target.value })
                  }
                  className="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-yellow dark:bg-gray-800"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, vendorPan: e.target.value })
                  }
                  className="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-yellow dark:bg-gray-800"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div>
                ...
                <select
                  value={formData.ac}
                  onChange={(e) =>
                    setFormData({ ...formData, ac: e.target.value === "true" })
                  }
                  className="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-yellow dark:bg-gray-800"
                >
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      extraHoursSurchargeRate: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-yellow dark:bg-gray-800"
                  placeholder="50"
              ...
              <div>
                <label className="block text-xs font-medium mb-1">
                  Food Surcharge Allowance (₹) *
                </label>
                <input
                  type="number"
                  required
                  value={formData.foodSurchargeAllowance}
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      foodSurchargeAllowance: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-yellow dark:bg-gray-800"
                  placeholder="0"
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      rcNumber: e.target.value.toUpperCase(),
                    })
                  }
                  className="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-yellow dark:bg-gray-800 uppercase"
              ...
              <DocumentUploadCard
                ...
                title="RC Document"
                description="Upload RC certificate"
                field="rcImage"
          ...
          <div className="space-y-3">
            ...
            {/* Insurance */}
            <div
              className={`p-3 space-y-3 rounded-lg border-2 ${insuranceWarning?.color || "border-gray-200"}`}
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium mb-1 flex items-center gap-2">
                    ...
                    {insuranceWarning && (
                      <span className="text-[10px] font-bold">
                        {insuranceWarning.icon} {insuranceWarning.text}
                      </span>
                    )}
                  </label>
                  <input
            ...
            {/* Pollution Certificate */}
            <div
              className={`p-3 space-y-3 rounded-lg border-2 ${pollutionWarning?.color || "border-gray-200"}`}
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium mb-1 flex items-center gap-2">
                    ...
                    {pollutionWarning && (
                      <span className="text-[10px] font-bold">
                        {pollutionWarning.icon} {pollutionWarning.text}
                      </span>
                    )}
                  </label>
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        pollutionNumber: e.target.value,
                      })
                    }
                    className="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-yellow dark:bg-gray-800"
            ...
            {/* Permit */}
            <div
              className={`p-3 space-y-3 rounded-lg border-2 ${permitWarning?.color || "border-gray-200"}`}
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium mb-1 flex items-center gap-2">
                    ...
                    {permitWarning && (
                      <span className="text-[10px] font-bold">
                        {permitWarning.icon} {permitWarning.text}
                      </span>
                    )}
                  </label>
                  <input
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        permitExpiryDate: e.target.value,
                      })
                    }
                    className="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-yellow dark:bg-gray-800"
                  />
              ...
              <DocumentUploadCard
                ...
                description="Upload permit certificate"
                field="permitImage"
                existingUrl={formData.permitImage}
              />
            </div>

            {/* Fitness Certificate */}
            <div
              className={`p-3 space-y-3 rounded-lg border-2 ${fitnessWarning?.color || "border-gray-200"}`}
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium mb-1 flex items-center gap-2">
                    ...
                    {fitnessWarning && (
                      <span className="text-[10px] font-bold">
                        {fitnessWarning.icon} {fitnessWarning.text}
                      </span>
                    )}
                  </label>
                  <input
              ...
              <DocumentUploadCard
                ...
                description="Upload fitness certificate"
                field="fitnessImage"
                existingUrl={formData.fitnessImage}
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            <h3 className="text-base font-semibold text-gray-800 dark:text-white flex items-center gap-2">
              <HiOutlinePhotograph className="text-primary-yellow" /> Vehicle
              Images (2-4 recommended)
            </h3>
              ...
              {formData.vehicleImages.map((url, index) => (
                <div key={index} className="relative group">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      const newImages = formData.vehicleImages.filter(
                        (_, i) => i !== index,
                      );
                      setFormData((prev) => ({
                        ...prev,
...
// r:bg-gray-50 dark:hover:bg-gray-800 transition-all"
//             >
//               Cancel
//             </button>
//             <button
